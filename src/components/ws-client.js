...
// imports Websocket/MozWebSocket

void (function (exports) {
  'use strict';

  const commandsWithNoBody = ['record', 'pause', 'stop', 'replay', 'replay-pause', 'saveMemory'];
  ...
  const WSClient = {
    props: ['uri'],
    template: '<div class="ws-client" style="display:none"/>',
    data() {
      return {
        isConnected: false,
        websocket: null,
